            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6 px-10 ">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-small font-medium flex flex-col p-4 md:p-0 mt-4 
                        ...
                        <li>
                        <NavLink to="/" className="block py-2 pl-3 pr-4  bg-blue-700 rounded md:bg-transparent md:p-0">Home</NavLink>
                        </li>
                        <li>
                        <NavLink to="/about" className="block py-2 pl-3 pr-4  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0  md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">About us</NavLink>
                        </li>
                        <li>
